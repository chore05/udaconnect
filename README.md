...
## Project structure
* deployment/ folder has kubernetes settings 

* docs/ folder contains
- Architecture choice justification
- Architecture diagram 
- Tutorial to run gRPC
- OpenAPI documentation
- Tutorial to run the Kafka servers
- postman library
- Screenshots of pods and services

* modules/ folder has project


Details about project instructions below.
